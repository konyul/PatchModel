...
class MMSegWrapper:
    ...
    def get_result(self, src_filename):
        if self.model:
            ...
            gt_dir = '/media/spalab/sdd/kypark/PatchModel/results_2nd_gt'
            ...
            if ext in ['.jpg', '.png', '.jpeg']:
                ...
                visualized_gt = draw_grid(visualized_gt)
                ...
                new_img_raw = np.concatenate((visualize_raw_img,visualized_img_raw,visualized_gt),axis=1)
