...
inf_file_path = f"/mnt/hdd2/project/PatchModel/data/human_anno/inference/{img_name}.npy"
inf_patch = np.load(inf_file_path)

for p in person:
    GT_file_path = f"/mnt/hdd2/project/PatchModel/data/human_anno/{p}/{img_name}.json"
