...
class MMSegWrapper:
    ...
    def download_model(self):
        config_file = './configs/patchnet/patchnet_CSPDark_s16_convnextv2_blurweight.py'
        checkpoint_file = '/media/spalab/sdd/kypark/PatchModel/work_dir/patchnet/patchnet_CSPDark_s16_convnextv2_blurweight/iter_40000.pth'
