# CONFIG=patchnet_hyundae_r34_512x512_wo_aug_lr5e-5_bs4_iter80k
CONFIG=patchnet_r34_convnextv2
CONFIG_PATH=patchnet
PORT=29501 CUDA_VISIBLE_DEVICES=0 tools/dist_train.sh configs/$CONFIG_PATH/$CONFIG.py 1 --work-dir work_dir/$CONFIG_PATH/$CONFIG
